...
abstract class InAppWebViewPlatform extends PlatformInterface {
  ...
  static set instance(InAppWebViewPlatform? instance) {
    ...
    // Note: PlatformInterface.verify skipped to support local path packages.
    _instance = instance;
  }

  /// Directly set the platform instance, bypassing all verification.
  /// Use this from main() to ensure the platform is always registered.
  static void forceSetInstance(InAppWebViewPlatform instance) {
    _instance = instance;
  }
